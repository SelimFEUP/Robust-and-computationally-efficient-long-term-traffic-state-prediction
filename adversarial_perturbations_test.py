...
import random
from src.preprocessing import load_data, num_features
...
class DeepProjectionLayer(tf.keras.layers.Layer):
    def __init__(self, d_model, num_hidden, dropout_rate=0.1):
        ...
        self.gate = Dense(num_hidden, activation='sigmoid')  # Gating mechanism
...
adversarial_test(model, X_test_scaled, y_test_scaled, epsilon=0.05) # epsilon=0.10, 0.20, 0.30
